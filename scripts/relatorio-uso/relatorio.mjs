...
const GRUPOS = [
  ...
  ['Gestão', ['gerente-veiculos', 'gerente-acessorios', 'lider-acessorios', 'lider-qualidade', 'diretor-qualidade']],
...
${secao('Gestão', ['gerente-veiculos', 'gerente-acessorios', 'lider-acessorios', 'lider-qualidade', 'diretor-qualidade'])}
