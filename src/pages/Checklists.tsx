...
const DEFAULT_TEMPLATES: Checklist[] = [
  {
    ...
    isTemplate: true,
    items: [
      { id: '1', text: 'Revisar histórico do cliente no CRM', checked: false },
      ...
      { id: '8', text: 'Preparar perguntas de descoberta (SPIN)', checked: false },
    ],
  },
  {
    id: 'tpl-2',
  ...
  },
  {
    ...
    isTemplate: true,
    items: [
      { id: '1', text: 'Definir BATNA (melhor alternativa)', checked: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '2', text: 'Registrar informações no CRM', checked: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '4', text: 'Atualizar forecast no CRM', checked: false },
