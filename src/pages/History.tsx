...
import { History as HistoryIcon, Wand2, Mic, Swords, Trash2, Clock, Search, Sparkles } from 'lucide-react';
...
const TYPE_CONFIG: Record<HistoryType, { label: string; icon: React.ComponentType<{ size?: number }>; color: string; route: string }> = {
  ...
  ai_coach_question: { label: 'Coach IA', icon: Sparkles, color: '#f59e0b', route: '/coach' },
};
...
const FILTERS: { value: HistoryType | 'all'; label: string }[] = [
  ...
  { value: 'ai_coach_question', label: 'Coach IA' },
];
